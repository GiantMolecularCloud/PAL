...
CALL SYSTEM.AFL_WRAPPER_GENERATOR ('PAL_TS_D', 'AFLPAL', 'DOUBLESMOOTH', PAL_TS_SIGNATURE);
...
UPDATE TS_PARAMS SET INTARGS=6 WHERE NAME='FORECAST_NUM';
UPDATE TS_PARAMS SET INTARGS=0 WHERE NAME='STARTTIME';

TRUNCATE TABLE TS_RESULTS;

CALL _SYS_AFL.PAL_TS_D (V_TS_DATA, TS_PARAMS, TS_RESULTS) WITH OVERVIEW;
