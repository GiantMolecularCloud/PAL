...
-- call : results inline
CALL "_SYS_AFL"."PAL_DECISION_TREE" ("PAL"."CLAIMS", "#PARAMS", ?, ?, ?, ?, ?);
...
CALL "_SYS_AFL"."PAL_DECISION_TREE" ("PAL"."CLAIMS", "#PARAMS", "MODEL", "DECISION_RULES", "CONFUSION_MATRIX", "STATISTICS", "PLACEHOLDER") WITH OVERVIEW;
SELECT * FROM "MODEL";
