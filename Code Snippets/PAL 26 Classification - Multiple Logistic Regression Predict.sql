...
CREATE TYPE PAL_T_RGP_DATA AS TABLE (ID INTEGER, LIFESPEND INTEGER, NEWSPEND INTEGER);
...
INSERT INTO RGP_PREDICT VALUES (1,3020,2600);
INSERT INTO RGP_PREDICT VALUES (2,5300,2020);
