...
CALL "SYS"."AFLLANG_WRAPPER_PROCEDURE_DROP"('DEVUSER', 'P_GB_P');
DROP TABLE "DATA";
DROP TABLE "PREDICT";

-- procedure setup
CREATE TYPE "T_DATA" AS TABLE ("ID" INTEGER, "POLICY" NVARCHAR(10), "AGE" INTEGER, "AMOUNT" INTEGER, "OCCUPATION" NVARCHAR(10));
CREATE TYPE "T_PREDICT" AS TABLE ("ID" INTEGER, "FRAUD" VARCHAR(1000), "PROBABILITY" DOUBLE);
...
CALL "SYS"."AFLLANG_WRAPPER_PROCEDURE_CREATE"('AFLPAL', 'GBDTPREDICT', 'DEVUSER', 'P_GB_P', "SIGNATURE");
...
CALL "P_GB_P" ("DATA", "#PARAMS", "MODEL", "PREDICT") WITH OVERVIEW;

SELECT d.*, p."FRAUD", "PROBABILITY" 
 FROM "DATA" d
