...
CALL "SYS"."AFLLANG_WRAPPER_PROCEDURE_DROP"('DEVUSER', 'P_BES');
DROP VIEW "V_DATA";
DROP TABLE "RESULTS";
DROP TABLE "STATS";
DROP VIEW "V_RESULTS";
...
CALL "SYS"."AFLLANG_WRAPPER_PROCEDURE_CREATE"('AFLPAL', 'BROWNEXPSMOOTH', 'DEVUSER', 'P_BES', "SIGNATURE");
...
INSERT INTO "#PARAMS" VALUES ('ADAPTIVE_METHOD', 0, null, null); -- 0 : Brown; 1 : Adaptive Brown
--INSERT INTO "#PARAMS" VALUES ('DELTA', null, 0.2, null); -- use with Adaptive Brown
INSERT INTO "#PARAMS" VALUES ('ALPHA', null, 0.1, null); -- defaults to 0.1 : Brown; 0.2 : Adaptive Brown
...
CALL "P_BES" ("V_DATA", "#PARAMS", "RESULTS", "STATS") WITH OVERVIEW;
