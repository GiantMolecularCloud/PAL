...
-- wrapper generator is executed as SYSTEM user so need to authorize SYSTEM user to read signature table
...
-- SYSTEM user must authorize users to call PAL procedures using AFL__SYS_AFL_AFLPAL_EXECUTE role
