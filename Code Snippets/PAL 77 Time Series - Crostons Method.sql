...
CALL "SYS"."AFLLANG_WRAPPER_PROCEDURE_CREATE"('AFLPAL', 'CROSTON', 'DEVUSER', 'P_CM', "SIGNATURE");
...
INSERT INTO "#PARAMS" VALUES ('METHOD', 0, null, null); -- 0 : Sporadic; 1 : Constant
...
CALL "P_CM" ("V_DATA", "#PARAMS", "RESULTS", "STATS") WITH OVERVIEW;
