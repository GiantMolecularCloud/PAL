...
CREATE TYPE PAL_T_RG_DATA AS TABLE (ID INTEGER, LIFESPEND DOUBLE, INCOME DOUBLE, LOYALTY DOUBLE, NEWSPEND DOUBLE);
...
CALL SYSTEM.AFL_WRAPPER_GENERATOR ('PAL_RG', 'AFLPAL', 'EXPREGRESSION', PAL_RG_SIGNATURE);

-- app setup

CREATE VIEW V_RG_DATA AS 
	SELECT ID, LIFESPEND, INCOME, LOYALTY, NEWSPEND
		FROM CUSTOMERS
	;
...
CREATE VIEW V_RG_FITTED AS
	SELECT a.ID, b.LIFESPEND, ROUND(a.FITTED,1) AS LIFESPEND_FITTED, b.INCOME, b.LOYALTY, b.NEWSPEND 
		FROM RG_FITTED a, V_RG_DATA b 
		WHERE a.ID = b.ID
	;

INSERT INTO RG_PARAMS VALUES ('THREAD_NUMBER', 2, null, null);
INSERT INTO RG_PARAMS VALUES ('VARIABLE_NUM', 3, null, null);
