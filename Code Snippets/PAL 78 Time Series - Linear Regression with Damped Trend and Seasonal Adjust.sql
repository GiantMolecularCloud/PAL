...
CALL "SYS"."AFLLANG_WRAPPER_PROCEDURE_DROP"('DEVUSER', 'P_LRDTSA');
DROP VIEW "V_DATA";
DROP TABLE "RESULTS";
DROP TABLE "STATS";
DROP VIEW "V_RESULTS";
...
CALL "SYS"."AFLLANG_WRAPPER_PROCEDURE_CREATE"('AFLPAL', 'LRWITHSEASONALADJUST', 'DEVUSER', 'P_LRDTSA', "SIGNATURE");
...
INSERT INTO "#PARAMS" VALUES ('FORECAST_LENGTH', 6, null, null);
INSERT INTO "#PARAMS" VALUES ('TREND', null, 1, null); -- between 0 and 1
INSERT INTO "#PARAMS" VALUES ('AFFECT_FUTURE_ONLY', 0, null, null); -- 0 : all; 1 : future only (use when trend <> 1)
INSERT INTO "#PARAMS" VALUES ('SEASONALITY', 1, null, null); -- 0 : none; 1 : yes & user input; 2 : auto detect 
INSERT INTO "#PARAMS" VALUES ('PERIODS', 3, null, null); -- specify when SEASONALITY is 1
...
--INSERT INTO "#PARAMS" VALUES ('IGNORE_ZERO', 1, null, null); -- use with MPE or MAPE
--INSERT INTO "#PARAMS" VALUES ('EXPOST_FLAG', 0, null, null); -- 0 : do not output; 1 : output expost forecast

TRUNCATE TABLE "RESULTS";
TRUNCATE TABLE "STATS";

CALL "P_LRDTSA" ("V_DATA", "#PARAMS", "STATS", "RESULTS") WITH OVERVIEW;
