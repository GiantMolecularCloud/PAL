...
-- PAL setup
CREATE TYPE PAL_T_DF_DATA AS TABLE (VALUE_LEFT DOUBLE, VALUE_RIGHT DOUBLE);
...
CALL SYSTEM.AFL_WRAPPER_GENERATOR ('PAL_DF', 'AFLPAL', 'DISTRFITCENSORED', PAL_DF_SIGNATURE);
...
INSERT INTO #DF_PARAMS VALUES ('DISTRIBUTIONNAME', null, null, 'WEIBULL'); -- Weibull only
INSERT INTO #DF_PARAMS VALUES ('OPTIMAL_METHOD', 1, null, null); -- 1: median rank

TRUNCATE TABLE DF_RESULTS;
TRUNCATE TABLE DF_STATS;

CALL _SYS_AFL.PAL_DF (FAILURES_CENSORED, #DF_PARAMS, DF_RESULTS, DF_STATS) WITH OVERVIEW;
